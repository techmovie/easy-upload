...
${extraScreenshot}`;
  ...
  const getKGInfo = async () => {
    var _a, _b, _c2, _d, _e, _f2, _g2, _h, _i;
    const {
      InternetLink,
      Year,
      Type,
    ...
    let genreVideoType = (_e = (_d = (_c2 = getBasicInfoDom("Genres").find("tr td>img").attr("src")) == null ? void 0 : _c2.match(/genreimages\/(\w+)\.\w+/)) == null ? void 0 : _d[1]) != null ? _e : "";
    ...
    let resolution = (_g2 = (_f2 = title.match(/\d{3,4}(p|i)/i)) == null ? void 0 : _f2[0]) != null ? _g2 : "";
    if (!resolution && resolution.match(/4k|uhd/i)) {
      resolution = "2160p";
    }
    TORRENT_INFO.videoCodec = getVideoCodecFromTitle(title);
...
${descriptionData}`;
  ...
  function getIMDBInfo() {
    ...
    const info = Object.fromEntries(Array.from(infoDom.find("b")).map((text2) => {
      var _a, _b, _c2;
      return [jQuery(text2).text().replace(":", ""), (_c2 = (_b = (_a = jQuery(text2)[0]) == null ? void 0 : _a.nextSibling) == null ? void 0 : _b.nodeValue) == null ? void 0 : _c2.trim()];
    }));
