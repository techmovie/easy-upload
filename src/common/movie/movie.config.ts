export const CONFIG = {
  URLS: {
    ...
    DOUBAN_SUBJECT: (id: string) => `https://movie.douban.com/subject/${id}/`,
    ...
    ROTTEN_TOMATOES_API:
      'https://79frdp12pn-1.algolianet.com/1/indexes/*/queries?x-algolia-agent=Algolia%20for%20JavaScript%20(4.24.0)%3B%20Browser%20(lite)&x-algolia-api-key=175588f6e5f8319b27702e4cc4013561&x-algolia-application-id=79FRDP12PN',
  },
  KEY: {
