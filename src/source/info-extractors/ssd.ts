...
class SSDExtractor extends NexusPHPExtractor {
  ...
  protected extractDoubanUrl (): void {
    this.info.doubanUrl = $(".douban_info a:contains('://movie.douban.com/subject/')").attr('href');
  }

  protected extractImdbUrl (): void {
    this.info.imdbUrl = $(".douban_info a:contains('://www.imdb.com/title/')").attr('href');
  }
  ...
  protected extractDoubanInfo (): void {
    ...
    this.info.doubanInfo = doubanPoster + doubanInfo?.replace(/\n{2,}/g, '\n') || '';
  }
